...
mkMerge [
  ...
  (mkIf config.networking.wireless.enable {
    ...
    age.secrets."wifi_eadrax" = {
      file = "${self}/secrets/shared/wifi_EadraxHB.age";
      mode = "0400";
      path = "/run/secrets/wifi_eadrax.env";
    };
...
/*
  ...
  # systemd.network = {
  #   # netdevs.dummy.enable = true;
  #   # netdevs.dummy.netdevConfig.Kind = "dummy";
  #   # netdevs.dummy.netdevConfig.Name = "dummy-nic";

  #   # networks.dummy-br.enable = true;
  #   # networks.dummy-br.matchConfig.Name = "dummy";
  #   # networks.dummy-br.bridge = [ "cont" ];

  #   netdevs.cont.enable = true;
  #   netdevs.cont.netdevConfig.Kind = "bridge";
  #   netdevs.cont.netdevConfig.Name = "cont";
  #   # netdevs.cont.macvlanConfig.Mode = "bridge";

  #   networks.cont.networkConfig.DNSSEC = false;
  #   networks.cont.matchConfig.Name = "cont";
  #   networks.cont.linkConfig.ARP = true;
  #   networks.cont.linkConfig.RequiredForOnline = "no";
  #   networks.cont.networkConfig.IPv6AcceptRA = "no";
  #   networks.cont.networkConfig.LinkLocalAddressing = "no";
  #   networks.cont.networkConfig.ConfigureWithoutCarrier = true;
  #   networks.cont.addresses = [{ addressConfig.Address = "10.40.1.222/24"; }];
  # };
