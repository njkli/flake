 ...
 *top-map*
 (list
  ...
  ;; navigation
  (kbd "C-M-Up")                  "move-focus up"
  (kbd "C-M-Down")                "move-focus down"
  (kbd "C-M-Right")               "move-focus right"
  (kbd "C-M-Left")                "move-focus left"
  ...
  (kbd "S-s-Down")                "zz-toggle-mode-line"

  ;; open a new tilix tab
  (kbd "C-S-RET")                 "exec tilix"
  ;; switch to tilix
  (kbd "C-s-RET")                 "tilix"
